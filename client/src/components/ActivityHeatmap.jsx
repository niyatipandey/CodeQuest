...
const ActivityHeatmap = ({activity}) => {
  ...
  return (
    ...
    <div className='grid grid-cols-10 gap-1 items-center mt-4 p-3'>
        {activity.map((act,index)=> (
            <div key={index} className={`h-4 w-4 ${getColor(act.count)} rounded-sm hover:scale-125 transition-transform duration-150`}
