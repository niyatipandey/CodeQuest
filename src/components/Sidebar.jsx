...
const Sidebar = ({setActivePage,activePage}) => {
  return (
    <div className='flex flex-col'>
        <button className='flex items-center gap-3 text-left px-4 py-2 rounded-lg text-gray-400 hover:bg-gray-400 transition-all hover:text-white'
        onClick={()=>
            setActivePage("dashboard")}
        ><LayoutDashboard size={16} /> Dashboard</button>
        <button className='flex items-center gap-3
        text-left px-4 py-2 rounded-lg text-gray-400 hover:bg-gray-400 transition-all hover:text-white'
        onClick={()=>
